            ...
            <div className='flex flex-col justify-start items-start '>
              ...
              <div className='flex flex-col pt-[20px]'>
                <div className='flex flex-col'>
                  <div className='text-[18px] font-normal text-[#D9D9D9] leading-normal'>{t('totakLockBalance')}</div>
              ...
              <div className="flex flex-col gap-[20px] pt-[53px]">
                <div className="flex flex-row gap-[20px] items-center">
                  ...
                  <div className="flex flex-col gap-[6px]">
                    <span className={'bg-gradient-to-b from-purple-400 to-blue-900 bg-clip-text text-transparent text-[18px] font-medium'}>{t('deposited')}</span>
                ...
                <div className="flex flex-row gap-[20px] items-center">
                  ...
                  <div className="flex flex-col gap-[6px]">
                    <span className={'bg-gradient-to-t from-green-300 to-green-700 bg-clip-text text-transparent text-[18px] font-medium'}>{t('earned')}</span>
