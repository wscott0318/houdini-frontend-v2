            ...
            <div className="flex flex-col gap-[30px]">
              <div className="flex flex-row gap-[55px]">
                <div className="flex flex-col gap-[10px]">
                  <span className='text-[18px] font-medium custom-xBlock-gold-gradient-text leading-normal'>{t('lastWeekSwaps')}</span>
                  <span className='text-[20px] font-medium leading-normal'>1,234,456</span>
                </div>
                <div className="flex flex-col gap-[10px]">
                  <span className='text-[18px] font-medium custom-xBlock-gold-gradient-text leading-normal'>{t('totalSwaps')}</span>
                  <span className='text-[20px] font-medium leading-normal'>34,456,030</span>
                </div>
              </div>
              <div className="flex flex-row gap-[50px]">
                <div className="flex flex-col gap-[10px]">
                  <span className='text-[18px] font-medium custom-xBlock-blue-gradient-text leading-normal'>{t('monthlyVolume')}</span>
                ...
                <div className="flex flex-col gap-[10px]">
                  <span className='text-[18px] font-medium custom-xBlock-blue-gradient-text leading-normal'>{t('totalVolume')}</span>
                  <div className='flex flex-row gap-[5px] items-center'>
                    <span className='text-[20px] font-medium leading-normal'>34,456,030</span>
                    <span className='bg-[#0000004D] rounded-[8px] px-[8px] py-[5px] text-[10px]'>$USD</span>
                  </div>
              ...
              <div className="flex flex-row gap-[30px]">
                <div className="flex flex-col gap-[10px]">
                  <span className='text-[18px] font-medium custom-xBlock-purple-gradient-text leading-normal'>{t('lastWeekBuybacks')}</span>
                  <div className='flex flex-row gap-[5px] items-center'>
                ...
                <div className="flex flex-col gap-[10px]">
                  <span className='text-[18px] font-medium custom-xBlock-purple-gradient-text'>{t('totalBuybacks')}</span>
                  <div className='flex flex-row gap-[5px] items-center'>
