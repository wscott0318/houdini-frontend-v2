      ...
      >
        <div className="flex flex-col gap-[30px] py-[50px]">
          ...
          <div className="lg:text-[19px] font-normal leading-[30px] text-[#B8CAFC] text-center">
            To initiate your transaction send the required funds to the wallet
            address in the order below
          </div>
        </div>
        <div className="flex flex-col pb-[165px]">
          <div className="flex flex-col items-center gap-[10px]">
            ...
            <div className="flex flex-col px-[100px] pt-[30px]">
              <div className="lg:text-[17px] text-center font-medium leading-[21.42px] rainbow-text text-[#FFFFFF]">
                When funds are received this page will auto refresh to display
                your transaction progress
              </div>
            </div>
...
const ModalStep2 = () => {
  return (
    <>
      <ModalStep>
        <div className="flex flex-row justify-between items-center w-[984px] h-[54px] px-[20px] py-[5px]">
          <OrderDetailRoundbox>
        ...
        <IndustrialCounterLockup>
          <div className="text-center w-full text-[46px] leading-[75.43px] font-bold ">
            Send Funds to Start Order
          </div>
          <div className="flex flex-col px-[30px] py-[10px] gap-[20px] w-full">
            <div className="text-center w-full text-[17px] leading-[21.42px] font-medium rainbow-text">
              Follow these steps
            </div>
            <Steps>
              ...
              <div className="flex flex-row w-full justify-center items-center gap-[10px]">
                <Image src={Eth} width={64} height={64} alt="ETH-ETH" />
                <div className="flex flex-row gap-[20px] justify-center items-center">
                  <div className="text-center leading-[24px] text-[20px] font-semibold whitespace-nowrap">
                    ETH(ERC-20)
                  </div>
                  <CopyBtnDemo
                    concept="1.0235"
            ...
            <Steps>
              ...
              <div className="flex flex-row gap-[20px] py-[10px] justify-center items-center">
                <CopyBtnDemo
                  concept="0xeed9978234bdffswfd8dhfe372b0154"
                  textColor="text-[#FBBF24]"
                  fontSize="text-[20px]"
                  fontWeight="text-semibold"
                  lineHeight="leading-[24px]"
          ...
          <div className="flex flex-row justify-between w-full items-center px-[30px] pt-5 left-0">
            <WalletRoundbox>
              <div className="relative flex flex-row justify-center items-center custom-wallet-shadow custom-wallet-gradient rounded-[15px] w-[110px] bg-red-900 p-2.5 bg-gradient-to-r from">
