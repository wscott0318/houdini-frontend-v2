    ...
    return(
        <>
          <div className="flex flex-row justify-between items-center w-full px-[10px] py-[5px]">
            <OrderDetailRoundbox>
                <div className="text-center text-[15px] font-bold text-[#FFFFFF] text-opacity-60">
                    Order ID:
                </div>
                <CopyBtnDemo concept="pR7h3raq71otwFuCqvSpqf" textColor="text-[#FFFFFF99]"/>
            </OrderDetailRoundbox>
            
            <OrderDetailRoundbox>
                <div className="text-center text-[15px] text-[#FFFFFF] leading-[24px] text-opacity-60 font-bold">
                    Creation Time:
                </div>
                <div className="text-center text-[15px] text-[#FFFFFF] leading-[24px] text-opacity-50 font-normal">
                    21/09/2023, 19:14:37
                </div>
            </OrderDetailRoundbox>
          </div>
          ...
          <IndustrialCounterLockup>
            <div className="text-center w-full text-[46px] leading-[75px] font-bold ">
                Send Funds to Start Order
            </div>
            <div className="flex flex-col px-[30px] py-[10px] gap-[20px] w-full">
                <div className="text-center w-full text-[17px] leading-[21px] font-medium rainbow-text">
                    Follow these steps
                </div>
                <Steps>
                    ...
                    <div className="flex flex-row w-full lg:w-auto justify-center items-center gap-[10px]">
                      ...
                      <div className="flex flex-row gap-[20px] justify-center items-center">
                          ...
                          <CopyBtnDemo concept="1.0235" textColor="text-[#FBBF24]" fontSize="text-[20px]" fontWeight="text-semibold" lineHeight="leading-[24px]"/>
                      </div>
                    </div>
                </Steps>
                ...
                <Steps>
                    ...
                    <div className="flex flex-row gap-[20px] py-[10px] justify-center items-center">
                        <CopyBtnDemo concept="0xeed9978234bdffswfd8dhfe372b0154" textColor="text-[#FBBF24]" fontSize="text-[20px]" fontWeight="text-semibold" lineHeight="leading-[24px]"/>
                    </div>
                </Steps>
            </div>
