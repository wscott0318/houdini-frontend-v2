export const IndustrialCounterLockup = ({children}: LayoutProps) => {
    return (
        <div className="relative p-[3px] rounded-[20px] custom-modal-step2-inner-shadow w-full">
            <div className="relative flex flex-col items-center backdrop-blur-[46px] w-full blur-46px custom-modal-step2-drop-shadow rounded-[20px] lg:px-[60px] lg:pt-[20px] lg:pb-[40px] px-[5px] py-[2px] z-[1]">
                {children}
