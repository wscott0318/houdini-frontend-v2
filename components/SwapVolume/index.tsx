                  ...
                  <div className='custom-swap-wheel-background rounded-[3px]'>
                    <div className="flex flex-row bg-[#434055] rounded-[3px]">
                      ...
                      {valueArr.map((value, index) => {
                        return (
                          <div className="px-[0.54px] custom-swap-wheel-number-pane-outborder">
                          <div key={value.toString() + index.toString()} className="custom-swap-wheel-number-pane-innerborder px-[0.55px]">
