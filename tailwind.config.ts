    ...
    function ({ addUtilities }: { addUtilities: any }) {
      const newUtilities = {
        ...
        '.custom-modal-step2-drop-shadow': {
          boxShadow:
            '0px 19.04445px 28.56668px 0px #000, 16.60834px 16.60834px 41.52084px 0px #000', //0px 4.76111px 19.04445px 0px rgba(255, 255, 255, 0.25) inset, 19.04445px 9.52223px 47.61113px 0px rgba(255, 255, 255, 0.70) inset,
        },
        '.custom-modal-step2-inner-shadow': {
          boxShadow:
            '0px 0px 10.04445px 0px rgba(255, 255, 255, 0.7) inset, 19.04445px 9.52223px 4.61113px 0px rgba(255, 255, 255, 0.1) inset',
        },
        ...
        '.custom-wallet-shadow': {
          boxShadow:
            '4.34689px 3.17345px 20px 0px rgba(255, 255, 255, 0.40) inset, 8px 8px 40px 0px rgba(0, 0, 0, 0.50)',
        },
        ...
        '.custom-industrial-counter-lockup-shadow': {
          boxShadow:
            '0px 1px 28.56668px 0px #555, 0px 4.76111px 19.04445px 0px rgba(255, 255, 255, 0.25) inset, 19.04445px 9.52223px 47.61113px 0px rgba(255, 255, 255, 0.70) inset, 16.60834px 16.60834px 41.52084px 0px #000',
