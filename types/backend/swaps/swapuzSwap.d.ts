...
export default class SwapuzSwap implements Swap {
    name: string;
    ...
    getQuote(amount: number, from: string, to: string, fixed: boolean, direction?: QuoteDirection): Promise<QuoteResult>;
