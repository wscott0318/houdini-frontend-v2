...
const faqs = [
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        ...
        <div>
          If the amount received is to be defined use Fixed instead of Variable
          Houdini Swap will compare rates and optimize for the lowest cost
        </div>
        ...
        <div className="font-bold">
          Send the entered amount of cryptocurrency to the Houdini Swap address
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        <div>
          Private transactions are cryptocurrency transactions where one of both
          parties involved are unable to see or trace the other’s wallet
          address.
        </div>
        <div>
          ...
          financial history in perpetuity. Such exposure creates the same issues
          and risks that would arise if you were to reveal your traditional bank
          accounts details to everyone you transacted with.
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        ...
        <div>
          All transactional log data is automatically deleted after 48 hours. No
          data is ever sold or provided to third parties. During the 48 hour
          window individual specific data is only provided if a partner exchange
          has flagged a security threat tied to the wallet exchanging the funds
          and expressly requests it or upon the request of law enforcement
          agencies. With more than $150 million in volume and 50,000
          transactions to date no user funds have ever been lost.
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        <div>
          At its core Houdini Swap is a liquidity aggregator that encompasses a
          suite of options allowing for private transactions. As the leading
          provider of private transactions for people in crypto, Houdini Swap
          technology includes leading non-custodial exchanges and best of class
          anonymous blockchains.
        </div>
        <div>
          When you swap, send or bridge with Houdini Swap your order is
          dynamically price optimized for the cheapest route. Exchange partners
          are regularly vetted to ensure they maintain effective real-time risk
          based KYC and AML processes. During your transaction Houdini Swap
          never has access to your funds, never receives a deposit from you,
          never transfers your assets or applies a fee.
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        ...
        tokens on leading anonymizing blockchains before swapping back again to
        your destination currency. Being sent from one exchange to another
        ...
        originating sender making the transaction untraceable and truly private.
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        <div>
          ...
          averaging between x and xx minutes. The time can vary due to a number
          of factors, such as the selected token pair and potential congestion
          on the respective blockchains. Blockchains with a large number of
          verifications and so a longer transaction confirmation time will also
          take longer.
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        All data is stored for 48 hours in order to allow enough time for you to
        reach out to Support should they need to. A user may elect to delete
        their order from records earlier if the transaction has already
        ...
        threat has been flagged tied to the wallet exchanging the funds and the
        exchange expressly requests it.
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        <div>
          Usually private transactions take between 20 and 40 minutes to
          complete with semi-private transactions taking less than 3 minutes to
          complete. The time can vary due to a number of factors, such as the
          selected token pair and potential congestion on the respective
          blockchains. Blockchains with a large number of verifications and so a
          longer transaction confirmation time will also take longer.
        </div>
        <div>
          If your order has not been processed after one-hour, feel free to
          contact our{' '}
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        The calculation is the average duration a transaction will take based on
        the historical performance of the exchanges through which the
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        ...
        Houdini Swap than you would by going directly to the selected exchanges,
        given Houdini Swap’s negotiating power with its exchange partners in
        almost all circumstances you will pay less using Houdini Swap. Houdini
        Swap does not charge any fees. In return for routing your transaction
        Houdini Swap receives a small commission paid from the exchange’s fee
        and as such does not impact your rate.
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        ...
        <div>
          ...
          factor in recent volatility in both the conversion rates of the token
          pair and potential exchange slippage while the transaction is being
          completed. Given this fixed rates are higher than variable rates.
        </div>
      </div>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        <div>
          If you have sent the wrong currency your funds are still safe. However
          it will require our{' '}
          <Link
            href="https://t.me/HoudiniSwapSupport_bot"
            target="_blank"
    ...
    content: (
      <div className="flex flex-col justify-start items-start gap-4">
        <div>
          ...
          transaction confirmation time network gas fees have spiked causing it
          to delay your transaction completion. To confirm this, we recommend
          searching your receiving wallet address history on a blockchain
          scanner such as etherscan or bscscan, and checking the transaction
          history. If you see a ‘pending’ deposit transaction, this is almost
          certainly a gas fee issue and will resolve itself in time.
        </div>
        <div>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-row justify-start items-start">
        If you need to privately send, swap or bridge to multiple wallets at the
        same time then Multi Send allows you to do so, saving you time and
        effort.
      </div>
    ),
  },
